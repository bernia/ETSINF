...
public class Recomendacion {
    ...
    protected LPIColaPrioridad<ReferenciasWeb> qp;
    ...
    public ReferenciasWeb[] maxKReferencias(int k) {
        ReferenciasWeb[] res;
        if (k <= noPags) {
            res = new ReferenciasWeb[k];
            for (int i = 0; i < k; i++) {
                res[i] = maxReferencias();
            }
        } else {
             res = new ReferenciasWeb[noPags];
