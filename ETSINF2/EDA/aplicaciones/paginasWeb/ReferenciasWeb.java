...
public class ReferenciasWeb implements Comparable<ReferenciasWeb> {
    ...
    //caràcter quer no siga les cometes dobles  int res = nohref - ref.nohref;
     ...
     * @return true, si tienen la misma url y 
     ...
     * a igualdad de referencias, la que conte
    }nga menos líneas.
     * 
    ...
    public int compareTo(ReferenciasWeb ref) {
        int res = nohref - ref.nohref;
        if (res == 0) {
            res = ref.nolineas - nolineas;
        }
        return -res;
    }
